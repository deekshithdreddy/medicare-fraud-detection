...
--
-- Host: localhost
-- Generation Time: Dec 03, 2024 at 02:14 PM
...
--
-- Database: `enhancing_medicare_fraud`
--
CREATE DATABASE IF NOT EXISTS `enhancing_medicare_fraud` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `enhancing_medicare_fraud`;
...
('82meq7n282mcmhs8jvzjf1lv6paj52de', 'eyJ1c2VyaWQiOjR9:1tFZJj:uL1pD3DsGgk-Xttk1-R5Dd42gCu1eqdvt1At90IJxSE', '2024-12-09 13:39:55.310772'),
('8fdmicvhf5pnh5vp7e3ejbhfed53iagv', 'eyJ1c2VyaWQiOjN9:1tFYM5:1R0ZxPuTVVVJDiDU3bg8oVCzSkGabEMnJJr3HMJCnMs', '2024-12-09 12:38:17.458631'),
...
('gnlzilp2bz0et7t5674a64payernsgfx', 'eyJ1c2VyaWQiOjF9:1qjZqu:7UU6J2PdPUbaVE-YvR_LnNRxFHVOhVaXhxdoPu55_cE', '2023-10-06 06:41:24.243341'),
...
('qvxeo1vkslm075g2h3w5787qf5aencj1', 'eyJ1c2VyaWQiOjJ9:1qjbcm:0N7GwWUzljmmzd2PwW_COEdIdW-q0eEs4OzWZrnqn_Q', '2023-10-06 08:34:56.692794'),
...
(3, 'Saran', 'Saran123@gmail.com', 'Saran', '9535866270', 'India', 'karnataka', 'Bangalore', '#8928,8th Cross,Malleshwaram', 'Male'),
(4, 'Manjunath', 'tmksmanju14@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,10th Cross,Vijayanagar', 'Male');
...
(28, 'SVM', '55.017301038062286'),
(29, 'Logistic Regression', '54.67128027681662'),
(30, 'Decision Tree Classifier', '52.24913494809689'),
(31, 'KNeighborsClassifier', '39.44636678200692'),
(32, 'Recurrent Neural Network (RNN)', '50.86505190311419');
...
(60, 'Fraud Detected', '50.0'),
(61, 'Fraud Not Detected', '50.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_medicare_fraud_detection`
--

CREATE TABLE IF NOT EXISTS `remote_user_medicare_fraud_detection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(300) NOT NULL,
  `BeneID` varchar(300) NOT NULL,
  `ClaimID` varchar(300) NOT NULL,
  `ClaimStartDt` varchar(300) NOT NULL,
  `ClaimEndDt` varchar(300) NOT NULL,
  `Provider` varchar(300) NOT NULL,
  `InscClaimAmtReimbursed` varchar(300) NOT NULL,
  `AttendingPhysician` varchar(300) NOT NULL,
  `OperatingPhysician` varchar(300) NOT NULL,
  `OtherPhysician` varchar(300) NOT NULL,
  `ClmDiagnosisCode1` varchar(300) NOT NULL,
  `ClmDiagnosisCode2` varchar(300) NOT NULL,
  `DeductibleAmtPaid` varchar(300) NOT NULL,
  `ClmAdmitDiagnosisCode` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=11 ;

--
-- Dumping data for table `remote_user_medicare_fraud_detection`
--

INSERT INTO `remote_user_medicare_fraud_detection` (`id`, `Fid`, `BeneID`, `ClaimID`, `ClaimStartDt`, `ClaimEndDt`, `Provider`, `InscClaimAmtReimbursed`, `AttendingPhysician`, `OperatingPhysician`, `OtherPhysician`, `ClmDiagnosisCode1`, `ClmDiagnosisCode2`, `DeductibleAmtPaid`, `ClmAdmitDiagnosisCode`, `Prediction`) VALUES
(7, '172.217.10.234-10.42.0.151-443-46890-6', 'BENE11004', 'CLM564511', '06-09-23', '06-09-23', 'PRV56011', '6371', 'PHY396851', 'NA', 'NA', '9986', '521280', '30357', '225000', 'Fraud Detected'),
(8, '216.58.219.227-10.42.0.151-443-44735-6', 'BENE11004', 'CLM739666', '22-12-23', '22-12-23', 'PRV56011', '2193', 'PHY385446', 'NA', 'PHY367216', '2931', '5084955', '185895', '702000', 'Fraud Not Detected'),
(9, '10.42.0.151-52.84.61.117-37384-80-6', 'BENE11005', 'CLM280220', '02-04-23', '02-04-23', 'PRV54080', '1326', 'PHY372623', 'NA', 'NA', '3452', '104256', '10125', '360000', 'Fraud Not Detected'),
(10, '10.42.0.151-74.125.22.188-37263-5228-6', 'BENE11019', 'CLM194514', '14-02-23', '14-02-23', 'PRV51948', '1922', 'PHY311797', 'NA', 'NA', '25073', '1288350', '12006', '900000', 'Fraud Detected');
